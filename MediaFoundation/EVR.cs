...
namespace MediaFoundation.EVR
{
    ...
    public interface IMFVideoProcessor
    {
        ...
        int GetAvailableVideoProcessorModes(
            ...
            /*[In, Out, MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(GMarshaler))] Guid[]*/out IntPtr ppVideoProcessingModes);
        ...
        int SetVideoProcessorMode(
            [In, MarshalAs(UnmanagedType.LPStruct)]ref Guid lpMode);
