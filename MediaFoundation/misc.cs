...
namespace MediaFoundation.Misc
{
    ...
    public class PropertyKey
    {
        ...
        public PropertyKey(Guid g, int id) {
            fmtid = g;
            pID = id;
        }
    }
    ...
    public class WMVConst {
        public readonly static PropertyKey MFPKEY_DXVA_ENABLED = new PropertyKey(new Guid( 0x58e28605, 0x1d51, 0x48ed,  0xa3, 0xeb, 0xf, 0x9b, 0xaf, 0x78, 0x5f, 0xbd ), 0x01 );
