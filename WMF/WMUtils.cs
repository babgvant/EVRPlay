...
namespace WindowsMediaLib
{
    ...
    sealed public class WMUtils
    {
        ...
        /// </summary>
        public static void FreeWMMediaType(WMMediaType mediaType)
        {
            if (mediaType != null)
            {
    ...
    public sealed class WMProfileIds
    {
        /// <summary>Windows Media Video 8 for Broadband (NTSC, 700 Kbps)</summary>
        public static readonly Guid V80_700NTSCVideo = new Guid("C8C2985F-E5D9-4538-9E23-9B21BF78F745");
        /// <summary>Windows Media Video 8 for Broadband (NTSC, 1400 Kbps)</summary>
        public static readonly Guid V80_1400NTSCVideo = new Guid("931D1BEE-617A-4bcd-9905-CCD0786683EE");
        /// <summary>Windows Media Video 8 for Broadband (PAL, 384 Kbps)</summary>
        public static readonly Guid V80_384PALVideo = new Guid("9227C692-AE62-4f72-A7EA-736062D0E21E");
        /// <summary>Windows Media Video 8 for Broadband (PAL, 700 Kbps)</summary>
        public static readonly Guid V80_700PALVideo = new Guid("EC298949-639B-45e2-96FD-4AB32D5919C2");
        /// <summary>Windows Media Audio 8 for ISDN (Better than CD quality, 96 Kbps)</summary>
        public static readonly Guid V80_96StereoAudio = new Guid("1FC81930-61F2-436f-9D33-349F2A1C0F10");
        /// <summary>Windows Media Audio 8 for ISDN (Better than CD quality, 128 Kbps)</summary>
        public static readonly Guid V80_128StereoAudio = new Guid("407B9450-8BDC-4ee5-88B8-6F527BD941F2");
        /// <summary>High to best quality based profile for VBR content that is quality constrained.</summary>
        public static readonly Guid V80_HIGHVBRVideo = new Guid("0F10D9D3-3B04-4fb0-A3D3-88D4AC854ACC");
        /// <summary>Best quality based profile for VBR content that is quality constrained.</summary>
        public static readonly Guid V80_BESTVBRVideo = new Guid("048439BA-309C-440e-9CB4-3DCCA3756423");
    }
}
