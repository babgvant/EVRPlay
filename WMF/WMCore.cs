...
namespace WindowsMediaLib
{
    ...
    public interface IWMBackupRestoreProps
    {
        ...
        int GetPropByIndex(
            ...
            out StreamBufferAttrDataType pType,
            out byte[] pValue,
            ref short pcbLength
            );
        ...
        int SetProp(
            [In] string pszName,
            [In] StreamBufferAttrDataType Type,
            [In] byte[] pValue,
            [In] short cbLength
            );
    ...
    public interface IWMDRMEditor
    {
        ...
        int GetDRMProperty(
            [In] string pwstrName,
            out StreamBufferAttrDataType pdwType,
            out byte[] pValue,
            ref short pcbLength
            );
    }
    ...
    public interface IWMDRMReader
    {
        ...
        int SetDRMProperty(
            [In] string pwstrName,
            [In] StreamBufferAttrDataType dwType,
            [In] byte[] pValue,
            [In] short cbLength
            );
    ...
    public interface IWMHeaderInfo3
    {
        ...
        void GetAttributeByIndex(
            ...
            [Out, In] ref ushort pcchNameLen, [Out] out StreamBufferAttrDataType pType,
        ...
        void GetAttributeByName(
            ...
            [Out] out StreamBufferAttrDataType pType,
            [Out, MarshalAs(UnmanagedType.LPArray)] byte[] pValue,
            [Out, In] ref ushort pcbLength);
        ...
        //   [In] ushort pwLangIndex, [Out, MarshalAs(UnmanagedType.LPArray)] ushort[] pwIndices,
        ...
        int GetAttributeIndices(
            [In] ushort wStreamNum,
            [In] string pwszName,
            [In] ushort pwLangIndex,
            out ushort pwIndices,
            ref ushort pwCount
            );
        ...
        void GetAttributeByIndexEx(
            ...
            [Out, MarshalAs(UnmanagedType.LPWStr)] StringBuilder pwszName,
            [Out, In] ref ushort pwNameLen, [Out] out StreamBufferAttrDataType pType,
        ...
        void ModifyAttribute([In] ushort wStreamNum, [In] ushort wIndex, [In] StreamBufferAttrDataType Type,
        ...
        void AddAttribute([In] ushort wStreamNum, [In, MarshalAs(UnmanagedType.LPWStr)] string pszName,
            [Out] out ushort pwIndex, [In] StreamBufferAttrDataType Type, [In] ushort wLangIndex,
    ...
    public interface IWMInputMediaProps : IWMMediaProps
    {
        ...
        new int SetMediaType(
            [In, MarshalAs(UnmanagedType.LPStruct)] DirectShowLib.AMMediaType pType
            );
    ...
    public interface IWMMediaProps
    {
        ...
        [PreserveSig]
        int SetMediaType(
            [In, MarshalAs(UnmanagedType.LPStruct)] DirectShowLib.AMMediaType pType//[In] WMMediaType pType
            );
    }
    ...
    public interface IWMOutputMediaProps : IWMMediaProps
    {
        ...
        [PreserveSig]
        new int GetMediaType(
            out DirectShowLib.AMMediaType pType,
            ref int pcbType
            );
    ...
    public interface IWMPropertyVault
    {
        ...
        int SetProperty(
            [In] string pszName,
            [In] StreamBufferAttrDataType pType,
            [In] byte[] pValue,
            [In] int dwSize
            );
    ...
    public interface IWMReaderAccelerator
    {
        ...
        int Notify(
            [In] int dwOutputNum,
            [In, MarshalAs(UnmanagedType.LPStruct)] DirectShowLib.AMMediaType pSubtype
            );
    }
    ...
    public interface IWMReaderCallbackAdvanced
    {
        ...
        int OnOutputPropsChanged(
            [In] int dwOutputNum,
            [In, MarshalAs(UnmanagedType.LPStruct)] DirectShowLib.AMMediaType pMediaType,
            [In] IntPtr pvContext
            );
    ...
    public interface IServiceProvider
    {
        [PreserveSig]
        int QueryService(
            [In, MarshalAs(UnmanagedType.LPStruct)] ref Guid guidService,
